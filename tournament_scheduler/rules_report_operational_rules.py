    ...
    return [
        ...
        },
        {
            ...
            "forklaring": (
                ...
                "istidsoppgave, og rapporteres derfor her i sesongrapporten og i egen "
                "seksjon i «Må planlegges manuelt»-visningen (manual_schedule.html). For "
                "klubber med flere lag i samme aldersgruppe vurderes klubbens samlede "
                "spillerpool først: når aggregatet har fått sine deltakelsesplasser, men "
                "fordelingen mellom lagnavnene er ujevn, klassifiseres avviket som "
                "intra_club_distribution og vises kun som informasjon -- det er ikke et "
                "manglende deltakelsesavvik, inngår ikke i reparasjonssøket og blokkerer "
                "ikke publisering alene. "
