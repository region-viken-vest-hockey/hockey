...
STRATEGIES: dict[str, ScraperStrategy] = {
    ...
    "Tønsberg": ScraperStrategy(
        ...
        event_pattern="FullCalendar timeGrid fc-time-grid-event bookings in iframe, clicked for Leietaker/Formål detail",
        initial_navigation=[
        ...
        credential_env_vars=[],
        direct_scraper=True,
        note="Bookup SPA — the public 'Se tilgjengelighet' view exposes full per-slot Leietaker/Formål detail with no login required.",
    ),
