...
| Multi-objective comparison | canonical `pareto` module | the one dominance relation and bounded per-objective-extreme down-select shared by Stage 3's multi-objective search and promoted-season maintenance; callers own only the objective vector |
