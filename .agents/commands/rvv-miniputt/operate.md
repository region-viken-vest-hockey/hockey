...
- **change tournament participants / make room for a team** -> `season.md`; inspect accepted-change protections and request constraints, evaluate verified swap/repair candidates including the consequences for every displaced team, and prefer the smallest legal coupled change before moving unrelated tournaments.
